...
}`,...J.parameters?.docs?.source},description:{story:`A collapsible rail that starts collapsed. The toggle button at the top expands
the rail to reveal labels and collapses it back to icons. \`footerItems\` are
pinned to the bottom.`,...J.parameters?.docs?.description}}},Y.parameters={...Y.parameters,docs:{...Y.parameters?.docs,source:{originalSource:`{
  render: () => {
    const styles = useStyles();
    return <div className={styles.frame}>
...
}`,...Z.parameters?.docs?.source},description:{story:'Setting `togglePosition="bottom"` pins the expand/collapse toggle below the\nitems, alongside any `footerItems`, instead of above them.',...Z.parameters?.docs?.description}}},Q=[`Interactive`,`CollapsibleRail`,`IconOnlyRail`,`ExpandedWithSubMenus`,`ToggleAtBottom`]})))()}$();export{J as CollapsibleRail,X as ExpandedWithSubMenus,Y as IconOnlyRail,q as Interactive,Z as ToggleAtBottom,Q as __namedExportsOrder,K as default};