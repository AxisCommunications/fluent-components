...
backward slides it in from the left. Defaults to \`false\`.`,name:`animateContent`,parent:{fileName:`examples/src/storybook/ui-patterns/components/composites/Wizard.tsx`,name:`WizardProps`},required:!1,tags:{},type:{name:`boolean`}},layout:{defaultValue:{value:`default`},declarations:[{fileName:`examples/src/storybook/ui-patterns/components/composites/Wizard.tsx`,name:`WizardProps`}],description:"Step indicator placement.\n\n- `default`: vertical labelled rail beside the content (modal / large drawer).\n- `compact`: horizontal numbered stepper above the content (small drawer / mobile).",name:`layout`,parent:{fileName:`examples/src/storybook/ui-patterns/components/composites/Wizard.tsx`,name:`WizardProps`},required:!1,tags:{},type:{name:`enum`,raw:`"compact" | "default"`,value:[{value:`"compact"`},{value:`"default"`}]}},surface:{defaultValue:{value:`overlay`},declarations:[{fileName:`examples/src/storybook/ui-patterns/components/composites/Wizard.tsx`,name:`WizardProps`}],description:"Surface chrome.\n\n- `overlay` (default): rounded corners and an elevation shadow.\n- `inline`: square corners with a leading divider, for docked drawers.",name:`surface`,parent:{fileName:`examples/src/storybook/ui-patterns/components/composites/Wizard.tsx`,name:`WizardProps`},required:!1,tags:{},type:{name:`enum`,raw:`"overlay" | "inline"`,value:[{value:`"overlay"`},{value:`"inline"`}]}},headerActions:{defaultValue:null,declarations:[{fileName:`examples/src/storybook/ui-patterns/components/composites/Wizard.tsx`,name:`WizardProps`}],description:`Optional header actions rendered next to the close button. Defaults to
